...
pub const STREAMS: phf::Map<&'static str, &'static str> = phf_map! {
    ...
    "feynman" => "https://youtube.com/live/2QSo1Zb2Xo4?feature=share",
    "tesla" => "https://youtube.com/live/3ppW3ZNnmDA?feature=share",
    "hawking" => "https://youtube.com/live/Me98sMD5KBs?feature=share",
    "pasteur" => "https://youtube.com/live/pzwmqGg6mT4?feature=share"
};
