...
pub const ALL_STREAMS: phf::Map<&'static str, phf::Map<&'static str, &'static str>> = phf_map! {
    ...
    "2025" => phf_map! {
        "asimov" => "https://www.twitch.tv/firstwa_red1",
        "asimov-yt" => "https://www.youtube.com/watch?v=bk6L7yV46k0",
        ...
        "capek" => "https://www.twitch.tv/firstwa_red1",
        "capek-yt" => "https://www.youtube.com/watch?v=xouJCgLDhf0",
